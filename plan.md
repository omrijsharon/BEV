...
- [ ] M2-T4.b Implement end-to-end live pixel-velocity estimator in runtime loop (persistent frame-to-frame tracking state) (Finished: ____-__-__ __:__)
- [ ] M2-T4.c Update per-keypoint and aggregate frame velocity each frame from tracked correspondences (Finished: ____-__-__ __:__)
- [ ] M2-T4.d Feed estimated velocity back into next-frame coarse/fine search-center placement in live pipeline (Finished: ____-__-__ __:__)
...
- [ ] M5-T3 Profile CPU/memory and optimize hot paths for 15 FPS sustained (Finished: ____-__-__ __:__)
- [ ] M5-T3.a Add pre-allocation and frame pipeline buffering checks (Finished: ____-__-__ __:__)
- [ ] M5-T4 Add runtime health watchdogs (MSP stale data, tracker failure streaks, map instability) (Finished: ____-__-__ __:__)
- [ ] M5-T5 Final acceptance run (10+ min continuous) and report (Finished: ____-__-__ __:__)
